import{d6 as Ve,aP as Oe,gV as Ge,gW as We,fn as $e,gX as Ke,gY as Xe,gZ as Ye,g_ as ze,g$ as qe,c7 as Ze,fk as ve,cS as Je,h0 as he,h1 as I,f6 as Z,h2 as Qe,h3 as Ue,h4 as U,h5 as Te,h as v,T as y,j as n,Z as O,a as _,bG as L,I as E,r as A,eP as k,gQ as es,dk as ss,z as oe,cs as ts,co as N,cx as ns,cy as is,b8 as os,h6 as rs,cb as Me,h7 as ce,h8 as as,fE as ls,eU as z,U as ge,c$ as H,cN as D}from"./strapi-BCpeuz29.js";import{c as ie}from"./cloneDeep-DF1JX0DB.js";import{_ as cs}from"./_baseEach-q2DaOUQP.js";const[ds,ps]=Ve("PermissionsDataManager"),Y=()=>ps("usePermissionsDataManager");var us=qe,hs=Ye,gs=Ze,ms=$e,fs=ze,xs=ve,Cs=Ge,bs=Xe,js=Ke,ys=We;function As(e,s,i){var t=xs(e),o=t||Cs(e)||ys(e);if(s=ms(s),i==null){var a=e&&e.constructor;o?i=t?new a:[]:js(e)?i=bs(a)?hs(fs(e)):{}:i={}}return(o?us:gs)(e,function(l,r,c){return s(i,l,r,c)}),i}var ks=As;const Ss=Oe(ks);function me(e,s){function i(t,o){return Ss(t,(a,l,r)=>(Je(l,o[r])||(a[r]=he(l)&&he(o[r])?i(l,o[r]):l),a))}return i(e,s)}const we=e=>Array.isArray(e)?e.reduce((s,i)=>(Array.isArray(i)?s.push(...we(i)):s.push(i),s),[]):[],V=e=>I(e)?we(Object.values(e).map(s=>I(s)?V(s):s)):[],_e=(e,s,i)=>e.find(t=>t.action===s&&t.subject===i),Os=e=>{const s=fe(e.plugins),i=fe(e.settings),t=xe(e.collectionTypes),o=xe(e.singleTypes);return[...s,...i,...t,...o]},fe=e=>Object.values(e).reduce((s,i)=>{const t=Object.values(i).reduce((o,a)=>{const l=Object.entries(a).reduce((r,[c,{conditions:d,properties:{enabled:p}}])=>(p&&r.push({action:c,subject:null,conditions:re(d),properties:{}}),r),[]);return[...o,...l]},[]);return[...s,...t]},[]),xe=e=>Object.entries(e).reduce((i,t)=>{const[o,a]=t,l=Object.entries(a).reduce((r,c)=>{const[d,p]=c;if(!V(p).some(h=>h))return r;if(!p?.properties?.enabled){const h=Object.entries(p.properties).reduce((C,f)=>{const[u,m]=f;return C.properties[u]=Pe(m),C},{action:d,subject:o,conditions:re(p.conditions),properties:{}});return[...r,h]}return p.properties.enabled&&r.push({action:d,subject:o,properties:{},conditions:re(p.conditions)}),r},[]);return[...i,...l]},[]),Pe=(e,s="")=>Object.entries(e).reduce((i,t)=>{const[o,a]=t;return I(a)?[...i,...Pe(a,`${s}${o}.`)]:(a&&!I(a)&&i.push(`${s}${o}`),i)},[]),re=e=>Object.entries(e).filter(([,s])=>s).map(([s])=>s),Ee=(e,s=[])=>e.reduce((i,t)=>(i[t.id]=s.indexOf(t.id)!==-1,i),{}),Ce=(e,s,i=[])=>e.reduce((t,{categoryId:o,childrenForm:a})=>{const l=a.reduce((r,c)=>(r[c.subCategoryId]=c.actions.reduce((d,p)=>{const g=_e(i,p.action,null);return d[p.action]={properties:{enabled:g!==void 0},conditions:Ee(s,g?.conditions??[])},d},{}),r),{});return t[o]=l,t},{}),$s=(e,s,i)=>{const t=({children:o=[]},a,l="")=>o.reduce((r,c)=>{if(c.children)return{...r,[c.value]:t(c,a,`${l}${c.value}.`)};const d=a.indexOf(`${l}${c.value}`)!==-1;return r[c.value]=d,r},{});return e.reduce((o,a)=>{const l=s.properties.find(({value:r})=>r===a);if(l){const r=i?.properties[l.value]??[],c=t(l,r);o.properties[a]=c}return o},{properties:{}})},be=({subjects:e,actions:s=[]},i,t=[])=>s.reduce((o,a)=>{const l=a.subjects.reduce((c,d)=>{const p=e.find(({uid:g})=>g===d)||null;return p&&(c[d]=p),c},{});if(Z(l))return o;const r=Object.keys(l).reduce((c,d)=>{const{actionId:p,applyToProperties:g}=a,f=l[d].properties.map(({value:x})=>x).every(x=>(g||[]).indexOf(x)===-1),u=_e(t,p,d),m=Ee(i,u?.conditions??[]);if(c[d]||(c[d]={}),Z(g)||f)return c[d][p]={properties:{enabled:u!==void 0},conditions:m},c;const b=$s(g,l[d],u);return c[d][p]={...b,conditions:m},c},{});return Qe(o,r)},{});function vs(e,s,i,t){for(var o=-1,a=e==null?0:e.length;++o<a;){var l=e[o];s(t,l,i(l),e)}return t}var Ts=vs,Ms=cs;function ws(e,s,i,t){return Ms(e,function(o,a,l){s(t,o,i(o),l)}),t}var _s=ws,Ps=Ts,Es=_s,Ls=$e,Ds=ve;function Rs(e,s){return function(i,t){var o=Ds(i)?Ps:Es,a=s?s():{};return o(i,e,Ls(t),a)}}var Ns=Rs,Is=Ue,Fs=Ns,Bs=Object.prototype,Hs=Bs.hasOwnProperty,Vs=Fs(function(e,s,i){Hs.call(e,i)?e[i].push(s):Is(e,i,[s])}),Gs=Vs;const ae=Oe(Gs),je=(e,s)=>Object.entries(ae(e,s)).map(([i,t])=>({category:i,categoryId:i.split(" ").join("-"),childrenForm:Object.entries(ae(t,"subCategory")).map(([o,a])=>({subCategoryName:o,subCategoryId:o.split(" ").join("-"),actions:a}))})),Q=e=>Object.keys(e).reduce((s,i)=>{const t=e[i];if(I(t)&&!U(t,"conditions"))return{...s,[i]:Q(t)};if(I(t)&&U(t,"conditions")&&!V(Te(t,"conditions")).some(a=>a)){const a=Object.keys(t.conditions).reduce((l,r)=>(l[r]=!1,l),{});return{...s,[i]:{...t,conditions:a}}}return s[i]=t,s},{}),q=(e,s,i=!1)=>Object.keys(e).reduce((t,o)=>{const a=e[o];return o==="conditions"&&!i?(t[o]=a,t):I(a)?{...t,[o]:q(a,s,o==="fields")}:(t[o]=s,t)},{}),R="12rem",de="20rem",se="5.3rem",pe=e=>e?Object.entries(e).reduce((s,[i,t])=>(i!=="conditions"&&(s[i]=t),s),{}):null,G=e=>{const s=pe(e),i=V(s);if(!i.length)return{hasAllActionsSelected:!1,hasSomeActionsSelected:!1};const t=i.every(a=>a),o=i.some(a=>a)&&!t;return{hasAllActionsSelected:t,hasSomeActionsSelected:o}},Le=v(y)`
...
`,Ne=({childrenForm:e=[],isFormDisabled:s,recursiveLevel:i,pathToDataFromActionRow:t,propertyActions:o,parentName:a,propertyName:l})=>{const{formatMessage:r}=_(),{modifiedData:c,onChangeParentCheckbox:d,onChangeSimpleCheckbox:p}=Y(),[g,h]=A.useState(null),C=u=>{h(m=>m===u?null:u)},f=A.useMemo(()=>g?e.find(({value:u})=>u===g):null,[g,e]);return n.jsxs(O,{paddingLeft:"3.2rem",children:[n.jsx(Js,{}),e.map(({label:u,value:m,required:b,children:x},j)=>{const $=j+1<e.length,M=Array.isArray(x),w=g===m;return n.jsxs(zs,{$isVisible:$,children:[n.jsxs(y,{height:se,children:[n.jsx(Qs,{children:n.jsx(Us,{width:"20",height:"23",viewBox:"0 0 20 23",fill:"none",xmlns:"http://www.w3.org/2000/svg",$color:"primary200",children:n.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M7.02477 14.7513C8.65865 17.0594 11.6046 18.6059 17.5596 18.8856C18.6836 18.9384 19.5976 19.8435 19.5976 20.9688V20.9688C19.5976 22.0941 18.6841 23.0125 17.5599 22.9643C10.9409 22.6805 6.454 20.9387 3.75496 17.1258C0.937988 13.1464 0.486328 7.39309 0.486328 0.593262H4.50974C4.50974 7.54693 5.06394 11.9813 7.02477 14.7513Z",fill:"#D9D8FF"})})}),n.jsxs(y,{style:{flex:1},children:[n.jsx(qs,{$level:i,$isActive:w,$isCollapsable:M,children:n.jsxs(Le,{alignItems:"center",$isCollapsable:M,...M&&{onClick:()=>C(m),"aria-expanded":w,onKeyDown:({key:S})=>(S==="Enter"||S===" ")&&C(m),tabIndex:0,role:"button"},title:u,children:[n.jsx(Zs,{ellipsis:!0,children:u}),b&&n.jsx(De,{}),n.jsx(J,{$isActive:w})]})}),n.jsx(y,{style:{flex:1},children:o.map(({actionId:S,label:P,isActionRelatedToCurrentProperty:W})=>{if(!W)return n.jsx(ue,{},S);const T=[...t.split(".."),S,"properties",l,...a.split(".."),m],K=k(c,T,!1);if(!x)return n.jsx(y,{position:"relative",width:R,justifyContent:"center",alignItems:"center",children:n.jsx(L,{disabled:s,name:T.join(".."),"aria-label":r({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${a} ${u} ${P}`}),onCheckedChange:B=>{p({target:{name:T.join(".."),value:!!B}})},checked:K})},P);const{hasAllActionsSelected:F,hasSomeActionsSelected:ne}=G(K);return n.jsx(y,{position:"relative",width:R,justifyContent:"center",alignItems:"center",children:n.jsx(L,{disabled:s,name:T.join(".."),"aria-label":r({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${a} ${u} ${P}`}),onCheckedChange:B=>{d({target:{name:T.join(".."),value:!!B}})},checked:ne?"indeterminate":F},P)},P)})})]})]}),f&&w&&n.jsx(O,{paddingBottom:2,children:n.jsx(Ne,{isFormDisabled:s,parentName:`${a}..${m}`,pathToDataFromActionRow:t,propertyActions:o,propertyName:l,recursiveLevel:i+1,childrenForm:f.children})})]},m)})]})},zs=v(O)`
...
`,et=({headers:e=[],label:s})=>{const{formatMessage:i}=_();return n.jsxs(y,{children:[n.jsx(y,{width:de,height:se,shrink:0,alignItems:"center",paddingLeft:6,children:n.jsx(E,{variant:"sigma",textColor:"neutral500",children:i({id:"Settings.roles.form.permission.property-label",defaultMessage:"{label} permissions"},{label:s})})}),e.map(t=>t.isActionRelatedToCurrentProperty?n.jsx(y,{width:R,shrink:0,justifyContent:"center",children:n.jsx(E,{variant:"sigma",textColor:"neutral500",children:i({id:`Settings.roles.form.permissions.${t.label.toLowerCase()}`,defaultMessage:t.label})})},t.label):n.jsx(y,{width:R,shrink:0},t.label))]})},ee=e=>es`
...
`,st=A.forwardRef(({onClick:e,className:s,hasConditions:i=!1,variant:t="tertiary"},o)=>{const{formatMessage:a}=_();return n.jsx(tt,{$hasConditions:i,className:s,children:n.jsx(oe,{variant:t,startIcon:n.jsx(ts,{}),onClick:e,ref:o,type:"button",children:a({id:"global.settings",defaultMessage:"Settings"})})})}),tt=v(O)`
